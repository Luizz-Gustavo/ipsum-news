...
function CreateUserSuccess({ isOpen, onClose, name, lastName }) {
    return (
        <>
            <Modal show={isOpen} onClose={onClose} size="lg" popup>
                ...
                <Modal.Body className="flex flex-col items-center justify-center mt-5">
                    ...
                    <p className="mt-5 text-md text-center">The user <span className="font-bold">{`${name} ${lastName}`}</span> was created successfully!</p>
                </Modal.Body>
